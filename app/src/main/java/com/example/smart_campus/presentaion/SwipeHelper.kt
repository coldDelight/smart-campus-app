package com.example.smart_campus.presentaion
...
class SwipeHelper(private val recyclerViewAdapter :GroupRecyclerAdapter) :ItemTouchHelper.Callback(){
    ...
    override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
        Log.e("ff", "onSwiped: ${viewHolder.itemId}", )
    }
    ...
    private fun getView(viewHolder: RecyclerView.ViewHolder) : View = viewHolder.itemView.findViewById(R.id.layout_group_item)
